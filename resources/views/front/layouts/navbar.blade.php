                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle @yield('team-active') @yield('testimonial-active')" data-bs-toggle="dropdown">Pages</a>
                            <div class="dropdown-menu m-0">
                                <a href="{{ route('front.team') }}" class="dropdown-item @yield('team-active')">Our Team</a>
                                <a href="{{ route('front.testimonial') }}" class="dropdown-item  @yield('testimonial-active')">Testimonial</a>
                            </div>
                        </div>
